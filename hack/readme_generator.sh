#!/usr/bin/env bash
# Automatically generates README.md for tasks and pipelines
# Usage: ./auto-pipeline-readme.sh tasks/apply-mapping

# TODO add documentation to this script
